        ...
        modalBody.innerHTML = `
            <div class="day-details">
                ...
                <div class="detail-item">
                    ...
                    <ul>
                        <li>Shower: ${day.checklist.shower ? '✅' : '❌'}</li>
                        <li>Clean: ${day.checklist.clean ? '✅' : '❌'}</li>
                        <li>Pushups (${day.pushupTarget}): ${day.checklist.pushups ? '✅' : '❌'}</li>
                        <li>Journal: ${day.checklist.journalDone ? '✅' : '❌'}</li>
                    </ul>
                </div>
                <div class="detail-item">
    ...
    renderTodoList() {
        ...
        this.data.todos.forEach(todo => {
            ...
            todoElement.innerHTML = `
                ...
                <button class="btn btn-small remove-todo" data-id="${todo.id}">×</button>
            `;
    ...
    renderReminders() {
        ...
        this.data.reminders.forEach(reminder => {
            ...
            reminderElement.innerHTML = `
                ...
                <button class="btn btn-small remove-reminder" data-id="${reminder.id}">×</button>
            `;
