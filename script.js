        ...
        for (let i = 0; i < 90; i++) {
            ...
            dayElement.innerHTML = `
                ...
                <div class="day-actions">
                    <span class="${this.data.days[i].checklist.shower ? 'completed' : 'pending'}">ðŸš¿</span>
                    <span class="${this.data.days[i].checklist.clean ? 'completed' : 'pending'}">ðŸ§¹</span>
                    <span class="${this.data.days[i].checklist.pushups ? 'completed' : 'pending'}">ðŸ’ª</span>
                    <span class="${this.data.days[i].checklist.journalDone ? 'completed' : 'pending'}">ðŸ“</span>
                </div>
            `;
            ...
            <div class="day-details">
                <div class="checklist-summary">
                    ...
                    <ul>
                        ...
                        <li>Pushups: ${day.checklist.pushups ? 'âœ…' : 'âŒ'}</li>
